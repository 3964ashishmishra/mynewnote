...
import avataars from "../images/register.jpg"
        ...
        <div>
            ...
            <div className="d-flex">
                ...
                <div className="col-md-7 ps-5 pe-5 pt-5" style={{ width: "50%" }}>
                    <Button className="mb-4" variant="text" color="" startIcon={<ArrowBackIcon />} component={Link} to="/" style={{ textTransform: "none", fontFamily: "'Poppins', sans-serif" }}>Home</Button>
                    ...
                    <form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        ...
                        <Button type="submit" fullWidth size="large" className="mb-4" variant="contained" color="" style={{textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "1.1rem" }}>Register now</Button>
                    </form>
